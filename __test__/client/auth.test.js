...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Frederic_Hyatt',
      password: '15FxO_GOwUdr8en',
      email: 'Olaf.Abernathy11@yahoo.com',
      name: 'Ashley Renner',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Generic',
          address1: 'revolutionize',
          address2: 'Liaison',
          landmark: 'Sleek',
          city: 'superstructure',
          isDefault: false,
          state: 'Credit',
          addressType: 'Gorgeous',
          fullName: 'Bike',
          mobile: 590,
          addressNo: 55
        }
      ...
      userType: 204,
      mobileNo: '(680) 700-6039',
      resetPasswordLink: {},
      loginRetryLimit: 921,
      loginReactiveTime: '2023-01-10T23:44:19.959Z',
      id: '62c277c840639bf53ce4f990'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Myrna_Ullrich',
        'password':'oy7iXeAQMA33RtN',
        'email':'Rowland.Heidenreich@hotmail.com',
        'name':'Martin Reilly',
        'shippingAddress':[{
          '_id':false,
          'pincode':'primary',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Rowland.Heidenreich@hotmail.com', });
