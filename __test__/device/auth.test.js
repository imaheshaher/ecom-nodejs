...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Calista65',
      password: 'BvMydOugZvXfD27',
      email: 'Wilbert_Kuhn40@hotmail.com',
      name: 'Fred Barton',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 405,
      mobileNo: '(476) 442-1475',
      resetPasswordLink: {},
      loginRetryLimit: 77,
      loginReactiveTime: '2023-02-21T01:15:53.159Z',
      id: '62c277c840639bf53ce4f924'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Brandyn_Mueller',
        'password':'53lNxWBBLXhSaea',
        'email':'Elwyn39@gmail.com',
        'name':'Bertha White',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Reunion',
